...
<head>
    ...
    <meta name="description" content="Lembaga Sertifikasi Profesi - Meningkatkan kompetensi profesional melalui sertifikasi berkualitas">
        ...
        <div class="container">
            ...
            <div class="about-grid">
                <div class="about-card">
                    ...
                    <h3>Misi Kami</h3>
                    <p>Memberikan layanan sertifikasi profesi yang berkualitas, transparan, dan terpercaya untuk meningkatkan daya saing tenaga kerja Indonesia</p>
                </div>
                <div class="about-card">
                    <div class="card-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <h3>Visi Kami</h3>
                    <p>Menjadi lembaga sertifikasi profesi terkemuka yang diakui secara nasional dan internasional dalam mengembangkan kompetensi SDM</p>
                </div>
                <div class="about-card">
                    <div class="card-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <h3>Nilai Kami</h3>
                    <p>Integritas, profesionalisme, dan komitmen dalam setiap layanan sertifikasi yang kami berikan kepada seluruh peserta</p>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="cert-grid">
                <div class="cert-card">
                    ...
                    <p>Sertifikasi untuk programmer, network engineer, database administrator, dan profesional IT lainnya</p>
                ...
                <div class="cert-card">
                    ...
                    <p>Sertifikasi untuk manajer, supervisor, dan profesional di bidang manajemen dan administrasi bisnis</p>
                    <div class="cert-gradient"></div>
                </div>
                <div class="cert-card">
                    <div class="cert-icon">
                    ...
                    <p>Sertifikasi untuk teknisi, operator, dan profesional di bidang teknik sipil, mesin, dan konstruksi</p>
                    <div class="cert-gradient"></div>
                </div>
                <div class="cert-card">
                    <div class="cert-icon">
                    ...
                    <p>Sertifikasi untuk staff hotel, tour guide, chef, dan profesional di industri perhotelan dan pariwisata</p>
                    <div class="cert-gradient"></div>
                </div>
                <div class="cert-card">
                    <div class="cert-icon">
                ...
                <div class="cert-card">
                    ...
                    <p>Sertifikasi untuk guru, instruktur, trainer, dan profesional di bidang pendidikan dan pelatihan</p>
                    <div class="cert-gradient"></div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="process-grid">
                <div class="process-card">
                    ...
                    <h3>Pendaftaran</h3>
                    <p>Daftar online melalui website kami dengan mengisi formulir dan melengkapi dokumen yang diperlukan</p>
                </div>
                <div class="process-card">
